...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un atleta a partir de su nombre");
		System.out.println("14. Salir de la aplicación\n");
	}

	/**
	 * Le muestra al usuario el pais de un atleta a partir de su nombre.
	 */
	private void nombreAtletaPais() {
		String pais, nombre;
		System.out.println("\n" + "------- Pais de un atleta -------" + "\n");
		nombre=input("Por favor pon el nombre del atleta que quier es que consulte");
		pais=calculadora.nombreAtletaPais(nombre);
		if (pais==null) {
